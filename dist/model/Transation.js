...
var Transation = /** @class */ (function () {
    ...
    __decorate([
        ...
        (0, typeorm_1.JoinColumn)({ name: 'to_user', referencedColumnName: 'id_account' }),
        __metadata("design:type", Account_1.default)
    ], Transation.prototype, "to_user", void 0);
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Account_1.default; }),
        (0, typeorm_1.JoinColumn)({ name: 'from_user', referencedColumnName: 'id_account' }),
        __metadata("design:type", Account_1.default)
    ...
    __decorate([
        (0, typeorm_1.Column)(),
        __metadata("design:type", String)
    ], Transation.prototype, "coin", void 0);
    __decorate([
        (0, typeorm_1.Column)(),
