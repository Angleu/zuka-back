...
var Address_1 = __importDefault(require("../model/Address"));
var User_1 = __importDefault(require("../model/User"));
var AddressServices = /** @class */ (function () {
    function AddressServices() {
    }
    AddressServices.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            var repository, addresses;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, repository.save(address)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, address];
                }
